...
# ROTATIONp
#cmaml
python3 main.py $ROT --model lamaml --memories 200 --batch_size 5 --replay_batch_size 10 --n_epochs 1 --glances 5 --opt_lr 0.1 \
...
#lamaml
python3 main.py $ROT --model lamaml --memories 200 --batch_size 5 --replay_batch_size 10 --n_epochs 1 --glances 5 --opt_lr 0.3 \
